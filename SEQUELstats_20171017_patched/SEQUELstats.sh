...
if [[ -z "${SEQUEL_RSCRIPT:+x}" ]] ; then SEQUEL_RSCRIPT="Rscript" ; fi
if ! [ -x "$(command -v $SEQUEL_RSCRIPT)" ]; then echo -e "\n${SCRIPT_Name}]:\tNo Rscript detected; add to PATH or set SEQUEL_RSCRIPT\n" ; exit 1 ; fi
